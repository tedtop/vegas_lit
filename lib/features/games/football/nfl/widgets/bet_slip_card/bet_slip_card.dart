...
import 'cubit/nfl_bet_slip_card_cubit.dart';

// ignore: must_be_immutable
class NflBetSlipCard extends StatefulWidget {
  const NflBetSlipCard._({Key key}) : super(key: key);
  ...
  static Builder route({
    ...
    return Builder(
      builder: (context) {
        return BlocProvider(
          create: (context) => NflBetSlipCardCubit()
            ..openBetSlipCard(
              betSlipCardData: betSlipCardData,
            ),
          child: const NflBetSlipCard._(),
        );
      },
    );
  }
  ...
  Widget build(BuildContext context) {
    return Builder(
      builder: (context) {
        ...
        final betSlipCardState = context.watch<NflBetSlipCardCubit>().state;
                                ...
                                showModalBottomSheet(
                                  ...
                                  builder: (_) => MultiBlocProvider(
                                    providers: [
                                      ...
                                      BlocProvider.value(
                                        value:
                                            context.read<NflBetSlipCardCubit>(),
                                      ),
                                    ],
                  ...
                  options: CarouselOptions(
                    ...
                    onPageChanged: (i, reason) {
                      ...
                      if (int.parse(betButtonState.mainOdds).isNegative) {
                        ...
                        context.read<NflBetSlipCardCubit>().updateBetAmount(
