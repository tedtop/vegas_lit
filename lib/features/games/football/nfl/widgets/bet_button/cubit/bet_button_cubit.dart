...
import 'package:vegas_lit/features/games/football/nfl/widgets/bet_button/screens/single_bet_slip_card.dart';
    ...
    if (isBetExists) {
      ...
      context.read<BetSlipCubit>().addBetSlip(
            betData: NflBetData(
              ...
              awayTeamScore: state.game.awayScore,
              homeTeamScore: state.game.homeScore,
              uid: state.uid,
