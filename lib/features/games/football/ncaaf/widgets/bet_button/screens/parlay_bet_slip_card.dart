...
class NcaafParlayBetSlipCard extends StatelessWidget {
  @override
  Widget build(BuildContext context) {
    return Builder(
      builder: (context) {
        final NcaafBetButtonState betButtonState = context.watch<NcaafBetButtonCubit>().state;
                  ...
                  child: Container(
                    ...
                    decoration: BoxDecoration(
                      ...
                      image: const DecorationImage(
                        image:
                            AssetImage('${Images.betGameBGPath}cfb-parlay.png'),
