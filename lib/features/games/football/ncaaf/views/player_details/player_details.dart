                  ...
                  if (state is PlayerDetailsOpened) {
                    return NcaafPlayerStatsBox(
                      ...
                      statset4: <String, dynamic>{
                        ...
                        'PD': state.playerStats.passesDefended,
...
class NcaafPlayerStatsBox extends StatelessWidget {
  const NcaafPlayerStatsBox({
    Key? key,
