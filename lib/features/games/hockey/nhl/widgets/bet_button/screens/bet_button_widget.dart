...
class BetButton extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    final betId =
        context.select((NhlBetButtonCubit cubit) => cubit.state.uniqueId);
    return BlocListener<ParlayBetButtonCubit, ParlayBetButtonState>(
      ...
      child: BlocListener<NhlBetButtonCubit, NhlBetButtonState>(
        listener: (context, state) {
          switch (state.status) {
        ...
        child: ElevatedButton(
          ...
          onPressed: () async {
            await context.read<NhlBetButtonCubit>().clickBetButton(
                  ...
                  nhlBetButtonCubit: context.read<NhlBetButtonCubit>(),
                );
          },
        ),
      ),
