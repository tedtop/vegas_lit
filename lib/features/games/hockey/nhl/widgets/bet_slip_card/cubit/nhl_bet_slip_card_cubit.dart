...
part 'nhl_bet_slip_card_state.dart';

class NhlBetSlipCardCubit extends Cubit<NhlBetSlipCardState> {
  NhlBetSlipCardCubit() : super(const NhlBetSlipCardState.initial());
