...
// import 'package:vegas_lit/features/games/baseball/mlb/widgets/bet_button/cubit/bet_button_cubit.dart';
...
//   }) {
//     final winTeamString =
//         winTeam == BetButtonWin.player1 ? 'player1' : 'player2';
...
//   }) async {
//     if (isMinimumVersion) {
//       if (betButtonState.game.date.isBefore(ESTDateTime.fetchTimeEST())) {
