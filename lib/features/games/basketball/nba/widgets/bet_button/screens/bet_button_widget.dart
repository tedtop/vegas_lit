...
class BetButton extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    final betId =
        context.select((NbaBetButtonCubit cubit) => cubit.state.uniqueId);
    return BlocListener<ParlayBetButtonCubit, ParlayBetButtonState>(
      ...
      child: BlocListener<NbaBetButtonCubit, NbaBetButtonState>(
        listener: (context, state) {
          switch (state.status) {
        ...
        child: ElevatedButton(
          ...
          onPressed: () async {
            await context.read<NbaBetButtonCubit>().clickBetButton(
                  ...
                  nbaBetButtonCubit: context.read<NbaBetButtonCubit>(),
                );
          },
        ),
      ),
