...
class MlbTeamStats {
  ...
  factory MlbTeamStats.fromJson(String str) =>
      MlbTeamStats.fromMap(json.decode(str));
  ...
  factory MlbTeamStats.fromMap(Map<String, dynamic> json) => MlbTeamStats(
        ...
        inningsPitchedDecimal: json['InningsPitchedDecimal'].toDouble(),
        ...
        earnedRunAverage: json['EarnedRunAverage'].toDouble(),
        ...
        walksHitsPerInningsPitched:
            json['WalksHitsPerInningsPitched'].toDouble(),
        pitchingBattingAverageAgainst:
            json['PitchingBattingAverageAgainst'].toDouble(),
        ...
        pitchingOnBasePercentage: json['PitchingOnBasePercentage'].toDouble(),
        pitchingSluggingPercentage:
            json['PitchingSluggingPercentage'].toDouble(),
        pitchingOnBasePlusSlugging:
            json['PitchingOnBasePlusSlugging'].toDouble(),
        pitchingStrikeoutsPerNineInnings:
            json['PitchingStrikeoutsPerNineInnings'].toDouble(),
        pitchingWalksPerNineInnings:
            json['PitchingWalksPerNineInnings'].toDouble(),
        pitchingBattingAverageOnBallsInPlay:
            json['PitchingBattingAverageOnBallsInPlay'].toDouble(),
        pitchingWeightedOnBasePercentage:
            json['PitchingWeightedOnBasePercentage'].toDouble(),
        ...
        fieldingIndependentPitching:
            json['FieldingIndependentPitching'].toDouble(),
